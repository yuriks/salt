    ...
    def setUpClass(cls):  # pylint: disable=arguments-differ
        ...
        try:
            ...
            if cls.uwsgi_proc is None:
                cls.uwsgi_proc = start_daemon(cls.uwsgi_bin, UwsgiDaemon, config_dir=cls.config_dir, check_port=cls.uwsgi_port)
            ...
            if cls.nginx_proc is None:
                cls.nginx_proc = start_daemon('nginx', NginxDaemon, config_dir=cls.config_dir, check_port=cls.nginx_port)
